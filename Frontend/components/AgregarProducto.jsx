...
const AgregarProducto = () => {
  const [formData, setFormData] = useState({
    ...
    categoria: 'producto', // Producto o accesorio (Valor por defecto: producto)
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const producto = {
        ...
        stock,
        categoria: formData.categoria, // Aquí agregamos la categoría
      };
      ...
      setFormData({
        ...
        recargo_6_5: false,
        ganancia: '30',
        categoria: 'producto', // Reiniciar la categoría a 'producto'
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-indigo-600  text-white rounded-md hover:bg-indigo-700  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
            >
